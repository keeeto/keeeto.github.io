...
<figure>
	<img src="{{ '/assets/images/Underfitting.png' | prepend: site.baseurl }}" alt="" width="550"> 
...
<figure>
	<img src="{{ '/assets/images/Overfitting.png' | prepend: site.baseurl }}" alt="" width="550"> 
...
<figure>
	<img src="{{ '/assets/images/Fitting.png' | prepend: site.baseurl }}" alt="" width="550"> 
